...
- Change the default value of `--network-allow-private-ips` to `false` for `mainnet` and `fuji` by @StephenButtolph in https://github.com/cryft-labs/cryftgo/pull/1773
...
- Prune X-chain State by @coffeeavax in https://github.com/cryft-labs/cryftgo/pull/1427
...
- Add more X-chain tests by @coffeeavax in https://github.com/cryft-labs/cryftgo/pull/1487
...
- Add CPU cycles and number of disk read/write metrics by pid by @coffeeavax in https://github.com/cryft-labs/cryftgo/pull/1334
...
- @coffeeavax made their first contribution in https://github.com/cryft-labs/cryftgo/pull/1334
...
- Update Fuji beacon ips by @StephenButtolph in https://github.com/cryft-labs/cryftgo/pull/1354
...
- Update incorrect fuji beacon IPs by @StephenButtolph in https://github.com/cryft-labs/cryftgo/pull/1392
...
- Skip AMI generation with Fuji tags by @StephenButtolph in https://github.com/cryft-labs/cryftgo/pull/1288
...
**These API format changes are breaking changes. https://api.avax.network and https://api.avax-test.network have been updated with this format. If you are using CryftGo APIs in your code, please ensure you have updated to the latest versions. See  https://docs.avax.network/apis/cryftgo/cb58-deprecation for details about the CB58 removal.**
...
- Suppressed the super cool `cryftgo` banner when `stdout` is not directed to a terminal
- Updated linter version
