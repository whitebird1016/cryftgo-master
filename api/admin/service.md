---
tags: [CryftGo APIs]
description: This page is an overview of the Admin API associated with CryftGo.
...
enabled, use [config flag `--api-admin-enabled=true`](/nodes/configure/cryftgo-config-flags.md#--api-admin-enabled-boolean).
...
:::note Aliasing a chain can also be done via the [Node API](/nodes/configure/cryftgo-config-flags.md#--chain-aliases-file-string).
