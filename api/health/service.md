---
tags: [CryftGo APIs]
description: This page is an overview of the Health API associated with CryftGo. This API can be used for measuring node health.
...
The frequency at which health checks are run can be specified with the [--health-check-frequency](/nodes/configure/cryftgo-config-flags.md) flag.
...
CryftGo supports using subnetIDs as tags.
