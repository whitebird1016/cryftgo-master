---
tags: [CryftGo APIs]
description: This page is an overview of the Info API associated with CryftGo.
...
Given a blockchain’s alias, get its ID. (See [`admin.aliasChain`](/reference/cryftgo/admin-api.md#adminaliaschain).)
