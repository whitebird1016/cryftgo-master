---
tags: [CryftGo APIs]
description: This page is an overview of the Keystore API associated with CryftGo.
...
[`keystore.importUser`](/reference/cryftgo/keystore-api.md#keystoreimportuser). The user’s password
remains encrypted.
