...
// any variables using the OS env. If the [CryftGoDataDirVar] var is used,
...
// [CryftGoDataDirVar] var is used, we expand the value of the variable with
