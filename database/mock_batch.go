...
// Source: github.com/cryft-labs/cryftgo/database (interfaces: Batch)
//
// Generated by this command:
//
//	mockgen -package=database -destination=database/mock_batch.go github.com/cryft-labs/cryftgo/database Batch
//
