...
// Source: github.com/cryft-labs/cryftgo/database (interfaces: Iterator)
//
// Generated by this command:
//
//	mockgen -package=database -destination=database/mock_iterator.go github.com/cryft-labs/cryftgo/database Iterator
//
