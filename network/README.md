...
As an example, nodes that are attempting to connect with an incompatible version of CryftGo or a significantly skewed local clock are rejected.
...
sequenceDiagram
    ...
    par
        Alice->>Bob: CryftGo v1.0.0
    and
        Bob->>Alice: CryftGo v1.11.4
    end
