...
# DOCKER_IMAGE=mycryftgo ./scripts/build_image.sh                # Build local single arch image with a custom image name
# DOCKER_IMAGE=avaplatform/cryftgo ./scripts/build_image.sh      # Build and push multi-arch image to docker hub
# DOCKER_IMAGE=localhost:5001/cryftgo ./scripts/build_image.sh   # Build and push multi-arch image to private registry
# DOCKER_IMAGE=localhost:5001/mycryftgo ./scripts/build_image.sh # Build and push multi-arch image to private registry with a custom image name
...
# The published name should be 'avaplatform/cryftgo', but to avoid unintentional
