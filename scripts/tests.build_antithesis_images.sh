...
# e.g.,
# TEST_SETUP=cryftgo ./scripts/tests.build_antithesis_images.sh                 # Test build of images for cryftgo test setup
# DEBUG=1 TEST_SETUP=cryftgo ./scripts/tests.build_antithesis_images.sh         # Retain the temporary compose path for troubleshooting
