...
### [Outbound Messages](https://github.com/cryft-labs/cryftgo/blob/master/message/outbound_msg_builder.go)
...
Currently, Cryftgo implements its own message serialization to communicate. In the future, Cryftgo will use protocol buffers to communicate.

### [Network](https://github.com/cryft-labs/cryftgo/blob/master/network/network.go)
...
## [Router](https://github.com/cryft-labs/cryftgo/blob/master/snow/networking/router/chain_router.go)
...
## [Handler](https://github.com/cryft-labs/cryftgo/blob/master/snow/networking/handler/handler.go)
...
## [Sender](https://github.com/cryft-labs/cryftgo/blob/master/snow/networking/sender/sender.go)
...
## [Consensus Engine](https://github.com/cryft-labs/cryftgo/blob/master/snow/consensus/snowman/consensus.go)
...
## [Blockchain Creation](https://github.com/cryft-labs/cryftgo/blob/master/chains/manager.go)
