...
| cryftgo/   | Defines an antithesis test setup for cryftgo's primary chains.                 |
...
When defining a new test setup - whether in the cryftgo repo or
...
The workload of the 'cryftgo' test setup can be invoked against an
arbitrary network:

```bash
$ AVAWL_URIS="http://10.0.20.3:9650 http://10.0.20.4:9650" go run ./tests/antithesis/cryftgo
```
