...
`$HOME/.cryftgo/configs/chains`, then `config.json` can be placed at
`$HOME/.cryftgo/configs/chains/X/config.json`.
...
[API](/reference/cryftgo/x-chain/api.md#avmgetaddresstxs).
