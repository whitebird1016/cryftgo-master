---
tags: [X-Chain, CryftGo APIs]
description: This page is an overview of the Exchange Chain (X-Chain) API associated with CryftGo.
sidebar_label: API
...
:::warning
Not recommended for use on Mainnet. See warning notice in [Keystore API](/reference/cryftgo/keystore-api.md).
:::
...
```json
{
  "jsonrpc": "2.0",
  "result": {
    "address": "X-cryft18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5"
  },
  "id": 1
}
```
...
curl -X POST --data '{
    ...
    "params" :{
        ...
        "from":["X-cryft18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5"],
        "changeAddr":"X-cryft1turszjwn05lflpewurw96rfrd3h6x8flgs5uf8",
        "username":"myUsername",
        "password":"myPassword"
    }
}' -H 'content-type:application/json;' 127.0.0.1:9650/ext/bc/X
...
curl -X POST --data '{
    ...
    "params" :{
        ...
        "minterSets":[
            {
                "minters":[
                    "X-cryft1turszjwn05lflpewurw96rfrd3h6x8flgs5uf8"
                ],
                "threshold": 1
            }
        ],
        "from": ["X-cryft1turszjwn05lflpewurw96rfrd3h6x8flgs5uf8"],
        "changeAddr": "X-cryft1turszjwn05lflpewurw96rfrd3h6x8flgs5uf8",
        "username":"myUsername",
        "password":"myPassword"
    }
...
curl -X POST --data '{
    ...
    "params" :{
        ...
        "minterSets":[
            {
                "minters":[
                    "X-cryft18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5"
                ],
                "threshold": 1
            },
            {
...
with [`avm.importKey`](/reference/cryftgo/x-chain/api.md#avmimportkey).
...
curl -X POST --data '{
    ...
    "params" :{
        "address":"X-cryft1c79e0dd0susp7dc8udq34jgk2yvve7hapvdyht"
    }
}' -H 'content-type:application/json;' 127.0.0.1:9650/ext/bc/X
```
        ...
        "exportedOutputs": [
          {
            ...
            "fxID": "spdxUxVJQbX85MGxMHbKw1sHxMnSqJ3QBzDyDYEP3h6TLuxqQ",
            "output": {
              "addresses": ["X-cryft1tnuesf6cqwnjw7fxjyk7lhch0vhf0v95wj5jvy"],
              "amount": 2569382395,
              "locktime": 0,
              "threshold": 1
            }
...
```json
{
  ...
  "fxID": "spdxUxVJQbX85MGxMHbKw1sHxMnSqJ3QBzDyDYEP3h6TLuxqQ",
  "output": {
    "addresses": ["X-cryft126rd3w35xwkmj8670zvf7y5r8k36qa9z9803wm"],
    "amount": 1530084210,
    "locktime": 0,
    "threshold": 1
  }
...
`X-cryft18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5` and `X-cryft1d09qn852zcy03sfc9hay2llmn9hsgnw4tp3dv6`.
...
curl -X POST --data '{
    ...
    "method" :"avm.getUTXOs",
    "params" :{
        "addresses":["X-cryft18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5", "X-cryft1d09qn852zcy03sfc9hay2llmn9hsgnw4tp3dv6"],
        "limit":5,
        "encoding": "hex"
    }
}' -H 'content-type:application/json;' 127.0.0.1:9650/ext/bc/X
...
curl -X POST --data '{
    ...
    "method" :"avm.getUTXOs",
    "params" :{
        "addresses":["X-cryft18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5"],
        "limit":5,
        "startIndex": {
            "address": "X-cryft18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5",
            "utxo": "kbUThAUfmBXUmRgTpgD6r3nLj7rJUGho6xyht5nouNNypH45j"
...
curl -X POST --data '{
    ...
    "method" :"avm.import",
    "params" :{
        "to":"X-cryft18jma8ppw3nhx5r4ap8clazz0dps7rv5ukulre5",
        "sourceChain":"C",
        "username":"myUsername",
        "password":"myPassword"
    }
...
[`avm.createVariableCapAsset`](/reference/cryftgo/x-chain/api.md#avmcreatevariablecapasset).
...
[`avm.createNFTAsset`](/reference/cryftgo/x-chain/api.md#avmcreatenftasset).
    ...
    "params" :{
        "outputs": [
            ...
            },
            {
                ...
                "to"      : "X-cryft18knvhxx8uhc0mwlgrfyzjcm2wrd6e60w37xrjq",
                "amount"  : 10
            }
        ],
        "memo"      : "hi, mom!",
