...
var (
	ErrProtocolVersionMismatch = errors.New("RPCChainVM protocol version mismatch between CryftGo and Virtual Machine plugin")
...
type Initializer interface {
	// Initialize provides CryftGo with compatibility, networking and
